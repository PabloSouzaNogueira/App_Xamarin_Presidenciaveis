...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Presidenciaveis.Android.dll" comes first in this list. */
		"Presidenciaveis.Android.dll",
		...
		"Presidenciaveis.Domain.dll",
		"Presidenciaveis.Infra.Data.dll",
	};
